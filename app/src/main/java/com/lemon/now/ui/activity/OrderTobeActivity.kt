...
class OrderTobeActivity : BaseActivity1<OrderViewModel, ActivityOrdertobeBinding>() {
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        mViewBind.now.setOnClickListener {
            ...
            val map = hashMapOf(
                ...
                "cUVxr56uydpK5vG1LAkDeCGOAj4gfkDx" to "all",
                "obhH38I5kIj71jbNKPzEFrKkelMHT" to bean?.obhH38I5kIj71jbNKPzEFrKkelMHT.toString()
            )
    ...
    private fun getData(isShowDialog: Boolean) {
        ...
        mViewModel.orderdetail2(isShowDialog,map)
    }
    ...
    override fun createObserver() {
        ...
        mViewModel.orderdetaildata.observe(this, Observer {
            if (it.rZ81DSU7WU4hny4ukGHljvjO41bfB == 1) {
                ...
                Glide.with(this).load(it.M7CdaEiz0WPh1Cs3iyzkg6Od?.pPQGUTNAxoA)
                    .into(mViewBind.productLogo)
                mViewBind.pfdroDCductName.text =
                    it.M7CdaEiz0WPh1Cs3iyzkg6Od?.zTAPvIwFI3Sv7UZv2SVGDrIOePGxxR9AqV
                mViewBind.orderid.text =
                    it.M7CdaEiz0WPh1Cs3iyzkg6Od?.sCVB4OFAaUm0Ba1V5nsjRGOuGvHSS8t

                mViewBind.amount.text = "₹ " + it.M7CdaEiz0WPh1Cs3iyzkg6Od?.WA4R2qnu5lhz7.toString()
                mViewBind.date.text =
                    it.M7CdaEiz0WPh1Cs3iyzkg6Od?.sktzZnR1tYbzNliF0ZUNLSQLWwz6g3hlyscpj

                mViewBind.receivedamount.text =
                    "₹ " + it.M7CdaEiz0WPh1Cs3iyzkg6Od?.noNz52nAR9teAGnKBK.toString()
                mViewBind.receivedate.text = it.M7CdaEiz0WPh1Cs3iyzkg6Od?.H6R0CCiFv5HCTm5AJ63k

                mViewBind.repaymentamount.text =
                    "₹ " + it.M7CdaEiz0WPh1Cs3iyzkg6Od?.Ei5rFw3ggCfFFxvogcCvdtX.toString()
                mViewBind.repaymentdate.text =
                    it.M7CdaEiz0WPh1Cs3iyzkg6Od?.obhH38I5kIj71jbNKPzEFrKkelMHT

                mViewBind.charge.text =
                    "₹ " + it.M7CdaEiz0WPh1Cs3iyzkg6Od?.nmcgG0t0bc5aLmVm8HEsDtTVOl4bJZN.toString()
                ...
                when (it.M7CdaEiz0WPh1Cs3iyzkg6Od.S1giqNNoozNFE8yRzARpD2VdSEkMd) {
                    4 -> {
                        val intent =
                            Intent(this, OrderRepaidActivity::class.java)
